...
export default function WeddingCompletePackagesPage() {
  ...
  return (
    <div
      className="page wedding-page wedding-complete-packages-page"
      ref={pageRef}
      lang={htmlLang}
    >
      <SiteTopbar
      ...
      <section
        ...
        aria-labelledby="wedding-complete-packages-hero-title"
      >
      ...
      <section
        ...
        aria-label={t(completeWeddingPackagesPageCopy.title)}
      >
        ...
        <div className="container wedding-christening-catalogue__inner">
          <ChristeningPricingGrid
            packages={completeWeddingPackages}
            copy={completeWeddingPackagesPageCopy}
            idPrefix="complete-wedding-package"
          />
        </div>
      </section>

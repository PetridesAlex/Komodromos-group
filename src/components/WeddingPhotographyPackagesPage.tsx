...
export default function WeddingPhotographyPackagesPage() {
  ...
  return (
    <div
      className="page wedding-page wedding-photography-packages-page"
      ref={pageRef}
      lang={htmlLang}
    >
      <SiteTopbar
      ...
      <section
        ...
        aria-labelledby="wedding-photography-packages-hero-title"
      >
      ...
      <section
        ...
        aria-label={t(photoWayPackagesPageCopy.title)}
      >
        ...
        <div className="container wedding-christening-catalogue__inner">
          <ChristeningPricingGrid
            packages={photoWayPackages}
            copy={photoWayPackagesPageCopy}
            idPrefix="photoway-package"
          />
        </div>
      </section>

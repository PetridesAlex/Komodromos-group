...
export default function GwContactPage() {
  ...
  return (
    <div className="gw-aviation-page gw-contact-page" ref={pageRef}>
      <section className="gw-contact-hero" aria-labelledby="gw-contact-hero-title">
        <GwImagePlaceholder variant="hero-bg" className="gw-contact-hero__bg" label="Insert image here" />
        <div className="gw-contact-hero__scrim" aria-hidden />
        <div className="container gw-contact-hero__inner">
          <p className="gw-contact-hero__eyebrow reveal">Global Wings · Contact</p>
          <h1 id="gw-contact-hero-title" className="gw-contact-hero__title reveal reveal-delay-1">
            {contactHero.title}
          </h1>
          <p className="gw-contact-hero__subtitle reveal reveal-delay-2">{contactHero.subtitle}</p>
          <p className="gw-contact-hero__lead reveal reveal-delay-3">{contactHero.lead}</p>
        </div>
      </section>
          ...
          <div className="container">
            ...
            <div className="gw-contact-offices-grid">
              {contactOffices.map((office, i) => (
                <article
                  key={office.id}
                  className={`gw-contact-office reveal reveal-delay-${Math.min(i + 1, 2)}`}
                >
                  ...
                  <div className="gw-contact-office__block">

...
export default function TaxNonDomCertificatePage() {
  ...
  const titles = TAX_NON_DOM_PAGE_TITLES[locale]
  ...
  return (
    <div className="page" ref={pageRef}>
      ...
      <div className="taxnex-root" lang={locale === 'en' ? 'en' : 'el'}>
        ...
        <header className="taxnex-page-hero" aria-labelledby="tax-nondom-h1">
        ...
        <main>
          <section className="taxnex-section taxnex-section--light taxnex-tic-section" aria-labelledby="tax-nondom-sidebar-h">
            <div className="container taxnex-guide">
              <motion.aside className="taxnex-guide__sidebar" {...fadeUp}>
                <h2 id="tax-nondom-sidebar-h" className="taxnex-guide__sidebar-title">
                  {titles.sidebar}
                </h2>
              ...
              <motion.article className="taxnex-guide__article taxnex-prose" {...fadeUp} aria-labelledby="tax-nondom-h1">
                <TaxNexGuideArticleBody locale={locale} blocks={TAX_NON_DOM_ARTICLE_BLOCKS} />
              </motion.article>
            </div>
          </section>
          ...
          <section className="taxnex-section taxnex-section--cta-bottom" aria-label={titles.contactCta}>
            <div className="container taxnex-bottom-cta">
              ...
              <h2 className="taxnex-h2 taxnex-h2--tight">
                {locale === 'en'
                  ? 'Need help with your non-dom certificate application?'
                  : 'Χρειάζεστε βοήθεια με την αίτηση για πιστοποιητικό μη κατοίκου;'}
              </h2>
              <p className="taxnex-muted">
                {locale === 'en'
                  ? 'We can help you prepare and submit your application to the Cyprus Tax Department and explain how the rules apply to your situation.'
                  : 'Μπορούμε να σας βοηθήσουμε στην προετοιμασία και υποβολή της αίτησής σας στο Τμήμα Φορολογίας και να εξηγήσουμε πώς εφαρμόζονται οι κανόνες στην περίπτωσή σας.'}
              </p>
              <TaxContactLink className="taxnex-btn taxnex-btn--primary taxnex-btn--lg" state={{ serviceInterest: 'Tax & Accounting Services' }}>
                {titles.primaryCta}
              </TaxContactLink>

...
import { weddingEditCopy } from '../data/weddingEditCopy'
...
export default function WeddingEditPage() {
  ...
  return (
    <div className="page wedding-page wedding-concierge-page wedding-edit-page" ref={pageRef} lang={htmlLang}>
      <SiteTopbar
        logoPathname="/"
        logoScrollToId="home"
        homeHref="/"
      ...
      <section
        ...
        aria-labelledby="wedding-edit-heading"
      >
        <div className="wedding-concierge-hero__backdrop" aria-hidden>
          <img
            className="wedding-concierge-hero__photo"
            src="/images/services/wedding-highlights/wedding-services/wedding-decor-cover-hero.webp"
            alt=""
            width={1536}
            height={1024}
            decoding="async"
        ...
        <div className="container wedding-concierge-hero__content">
          ...
          <h1 id="wedding-edit-heading" className="wedding-concierge-hero__title">
            {t(copy.pageTitle)}
          </h1>
      ...
      <section className="wedding-concierge-faq" aria-labelledby="wedding-edit-faq-title">
        <div className="container wedding-concierge-faq__shell">
          <header className="wedding-concierge-faq__header reveal">
            ...
            <h2 id="wedding-edit-faq-title" className="wedding-concierge-faq__title">
              {t(copy.faqTitle)}
            </h2>
            <span className="wedding-concierge-faq__rule" aria-hidden />
            <p className="wedding-concierge-faq__count">
              <span className="wedding-concierge-faq__count-num">{copy.articles.length}</span>
              <span className="wedding-concierge-faq__count-label">{t(copy.articlesLabel)}</span>
            </p>
          </header>
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      id={`wedding-edit-q-${article.id}`}
                      aria-controls={`wedding-edit-a-${article.id}`}
                    >
                      <span className="wedding-concierge-faq__q-index" aria-hidden>
                        {article.id}
                      </span>
                      <span className="wedding-concierge-faq__q-text">{t(article.title)}</span>
                    ...
                    <div
                      id={`wedding-edit-a-${article.id}`}
                      role="region"
                      aria-labelledby={`wedding-edit-q-${article.id}`}
                      hidden={!isOpen}
      ...
      <section className="wedding-concierge-close" aria-labelledby="wedding-edit-close-title">
        <div className="container wedding-concierge-close__inner">
          ...
          <h2 id="wedding-edit-close-title" className="wedding-concierge-close__lead">
            {t(copy.closingLead)}
          </h2>

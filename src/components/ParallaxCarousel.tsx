...
const ParallaxCarousel = React.forwardRef<ParallaxCarouselRef, ParallaxCarouselProps>(
  (
    ...
    return (
      <div
        ref={containerRef}
        className={cn('parallax-carousel', className)}
        style={{
          cursor: 'grab',
          touchAction: 'pan-y',
          ...style,
      ...
      >
        <Canvas
          ...
          dpr={[1, 2]}
          className="parallax-carousel__canvas"
        >
          <CameraRig />
          {images.map((src, i) => (
            <Plane
        ...
        {showProgress && !loop ? (
          <div className="parallax-carousel__progress" aria-hidden>
            <div
              ref={progressBarRef}
              className="parallax-carousel__progress-bar"

...
export const weddingPackageCategories: WeddingPackageCategory[] = [
  {
    ...
    tagline: {
      en: 'Three investment levels — from guided coordination to fully bespoke Wedding Sky production.',
      el: 'Τρία επίπεδα επένδυσης — από καθοδηγούμενο συντονισμό έως πλήρως εξατομικευμένη παραγωγή Wedding Sky.',
      ru: 'Три уровня — от сопровождения координации до полностью индивидуальной организации Wedding Sky.',
    },
...
export const weddingPackages: WeddingPackageTier[] = [
  {
    ...
    tagline: {
      en: 'Structured planning support and assured day-of coordination for a polished Cyprus wedding.',
      el: 'Δομημένη οργανωτική υποστήριξη και σίγουρος συντονισμός την ημέρα του γάμου για μια κομψή τελετή στην Κύπρο.',
      ru: 'Структурированная поддержка в подготовке и уверенная координация в день свадьбы для безупречного торжества на Кипре.',
    },
  ...
  },
  {
    ...
    tagline: {
      en: 'Expanded design oversight, curated suppliers, and cohesive production for a richer celebration.',
      el: 'Εμπλουτισμένη αισθητική επιμέλεια, επιλεγμένοι συνεργάτες και ολοκληρωμένη παραγωγή για μια πιο βιωματική γιορτή.',
      ru: 'Расширенное дизайнерское сопровождение, отобранные партнёры и цельная организация для более насыщенного торжества.',
    },
  ...
  },
  {
    ...
    tagline: {
      en: "Wedding Sky's most elevated commission — tailored concept, premium partners, and dedicated stewardship throughout.",
      el: 'Το πιο αναβαθμισμένο πρόγραμμα της Wedding Sky — εξατομικευμένη ιδέα, premium συνεργάτες και αφοσιωμένη επιμέλεια σε κάθε στάδιο.',
      ru: 'Самый высокий уровень Wedding Sky — индивидуальная концепция, премиальные партнёры и персональное сопровождение на каждом этапе.',
    },

...
export const superLuxuryCarCards: SuperLuxuryCarCard[] = [
  ...
  },
  {
    ...
    image: `${PORSCHE}/porche-1-cover.webp`,
...
export const mercedesSClassDetail: SuperLuxuryCarDetail = {
  ...
  gallery: [
    ...
    `${MERCEDES}/mercedes-s-class-7.png`,
    ...
    `${MERCEDES}/mercedes-s-class-16.png`,
    ...
    `${MERCEDES}/mercedes-s-class-22.png`,
    `${MERCEDES}/mercedes-s-class-23.png`,
    `${MERCEDES}/mercedes-s-class-24.png`,
